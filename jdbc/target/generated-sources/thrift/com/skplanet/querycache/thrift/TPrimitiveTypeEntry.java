...
public class TPrimitiveTypeEntry implements org.apache.thrift.TBase<TPrimitiveTypeEntry, TPrimitiveTypeEntry._Fields>, java.io.Serializable, Cloneable, Comparable<TPrimitiveTypeEntry> {
  ...
  private _Fields optionals[] = {_Fields.LEN,_Fields.POSITION,_Fields.SCALE};
  ...
  public TPrimitiveTypeEntry setLen(int len) {
    this.len = len;
    setLenIsSet(true);
    return this;
  }
  ...
  public TPrimitiveTypeEntry setPosition(int position) {
  ...
  public TPrimitiveTypeEntry setScale(int scale) {
    this.scale = scale;
    setScaleIsSet(true);
    return this;
  }
