...
import com.skplanet.querycache.cli.thrift.TGetTableTypesResp;
import com.skplanet.querycache.cli.thrift.TGetTablesReq;
import com.skplanet.querycache.cli.thrift.TGetTablesResp;
import com.skplanet.querycache.cli.thrift.TGetTypeInfoReq;
import com.skplanet.querycache.cli.thrift.TGetTypeInfoResp;
...
public class QCDatabaseMetaData implements DatabaseMetaData {
   ...
   *
   */
  public QCDatabaseMetaData(TCLIService.Iface client, TSessionHandle sessHandle) {
    this.client = client;
  ...
  public String getDriverName() throws SQLException {
    return QCDriver.fetchManifestAttribute(Attributes.Name.IMPLEMENTATION_TITLE);
  }

  public String getDriverVersion() throws SQLException {
    return QCDriver.fetchManifestAttribute(Attributes.Name.IMPLEMENTATION_VERSION);
  }
  ...
  public ResultSet getUDTs(String catalog, String schemaPattern,
    ...
    return new QCMetaDataResultSet(
  ...
  public static void main(String[] args) throws SQLException {
    QCDatabaseMetaData meta = new QCDatabaseMetaData(null, null);
