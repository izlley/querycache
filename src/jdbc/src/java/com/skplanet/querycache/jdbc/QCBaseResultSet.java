...
import com.skplanet.querycache.service.cli.Type;
//import com.skplanet.querycache.service.cli.thrift.TBoolValue;
//import com.skplanet.querycache.service.cli.thrift.TByteValue;
//import com.skplanet.querycache.service.cli.thrift.TColumnValue;
//import com.skplanet.querycache.service.cli.thrift.TDoubleValue;
//import com.skplanet.querycache.service.cli.thrift.TI16Value;
//import com.skplanet.querycache.service.cli.thrift.TI32Value;
//import com.skplanet.querycache.service.cli.thrift.TI64Value;
...
public abstract class QCBaseResultSet implements ResultSet {
  ...
  public ResultSetMetaData getMetaData() throws SQLException {
    return new QCResultSetMetaData(columnNames, columnTypes);
  }
  ...
  */
  ...
  private Object getColumnValue(int columnIndex) throws SQLException {
    ...
    case TINYINT_TYPE:
      return tColumnValue.getByteVal();
    case SMALLINT_TYPE:
      return tColumnValue.getI16Val();
    case INT_TYPE:
      return tColumnValue.getI32Val();
    case BIGINT_TYPE:
      return tColumnValue.getI64Val();
    case TIMESTAMP_TYPE:
      return new Timestamp(tColumnValue.getI64Val());
    case FLOAT_TYPE:
      return tColumnValue.getDoubleVal();
    case DOUBLE_TYPE:
      return tColumnValue.getDoubleVal();
    case STRING_TYPE:
      return getStringValue(tColumnValue.getStringVal());
