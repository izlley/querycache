   ...
   public static void main(String[] args) throws InterruptedException {
      ...
      try {
         ...
         for (int i = 0; i < sProfile.size(); i++) {
           ...
           case 3:System.out.println("PROFILE: GetRowCount time elapsed : " + sProfile.get(i) + "ms");break;
           case 4:System.out.println("PROFILE: GetMeta time elapsed : " + sProfile.get(i) + "ms");break;
           case 5:System.out.println("PROFILE: Fetch time elapsed : " + sProfile.get(i) + "ms");break;
           }
         }
