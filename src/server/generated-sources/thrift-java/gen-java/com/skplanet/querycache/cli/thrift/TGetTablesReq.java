            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableTypes = new ArrayList<String>(_list38.size);
                for (int _i39 = 0; _i39 < _list38.size; ++_i39)
                {
                  String _elem40;
                  _elem40 = iprot.readString();
                  struct.tableTypes.add(_elem40);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tableTypes != null) {
        if (struct.isSetTableTypes()) {
          oprot.writeFieldBegin(TABLE_TYPES_FIELD_DESC);
          {
            ...
            for (String _iter41 : struct.tableTypes)
            {
      ...
      if (struct.isSetTableTypes()) {
        {
          ...
          for (String _iter42 : struct.tableTypes)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.tableTypes = new ArrayList<String>(_list43.size);
          for (int _i44 = 0; _i44 < _list43.size; ++_i44)
          {
            String _elem45;
            _elem45 = iprot.readString();
            struct.tableTypes.add(_elem45);
          }
        }
        struct.setTableTypesIsSet(true);
      }
