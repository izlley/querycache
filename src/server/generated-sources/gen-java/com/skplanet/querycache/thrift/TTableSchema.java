...
public class TTableSchema implements org.apache.thrift.TBase<TTableSchema, TTableSchema._Fields>, java.io.Serializable, Cloneable, Comparable<TTableSchema> {
  ...
  public List<com.skplanet.querycache.thrift.TColumnDesc> columns; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.COLUMNS, new org.apache.thrift.meta_data.FieldMetaData("columns", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.skplanet.querycache.thrift.TColumnDesc.class))));
  ...
  public TTableSchema(
    List<com.skplanet.querycache.thrift.TColumnDesc> columns)
  {
    this();
  ...
  public TTableSchema(TTableSchema other) {
    if (other.isSetColumns()) {
      List<com.skplanet.querycache.thrift.TColumnDesc> __this__columns = new ArrayList<com.skplanet.querycache.thrift.TColumnDesc>(other.columns.size());
      for (com.skplanet.querycache.thrift.TColumnDesc other_element : other.columns) {
        __this__columns.add(new com.skplanet.querycache.thrift.TColumnDesc(other_element));
      }
  ...
  public java.util.Iterator<com.skplanet.querycache.thrift.TColumnDesc> getColumnsIterator() {
    return (this.columns == null) ? null : this.columns.iterator();
  }

  public void addToColumns(com.skplanet.querycache.thrift.TColumnDesc elem) {
    if (this.columns == null) {
      this.columns = new ArrayList<com.skplanet.querycache.thrift.TColumnDesc>();
    }
    this.columns.add(elem);
  }

  public List<com.skplanet.querycache.thrift.TColumnDesc> getColumns() {
    return this.columns;
  }

  public TTableSchema setColumns(List<com.skplanet.querycache.thrift.TColumnDesc> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case COLUMNS:
      if (value == null) {
        ...
        setColumns((List<com.skplanet.querycache.thrift.TColumnDesc>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new ArrayList<com.skplanet.querycache.thrift.TColumnDesc>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  com.skplanet.querycache.thrift.TColumnDesc _elem10;
                  _elem10 = new com.skplanet.querycache.thrift.TColumnDesc();
                  _elem10.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTableSchema struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (com.skplanet.querycache.thrift.TColumnDesc _iter11 : struct.columns)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TTableSchemaTupleScheme extends TupleScheme<TTableSchema> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TTableSchema struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (com.skplanet.querycache.thrift.TColumnDesc _iter12 : struct.columns)
        {
          _iter12.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTableSchema struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.columns = new ArrayList<com.skplanet.querycache.thrift.TColumnDesc>(_list13.size);
        for (int _i14 = 0; _i14 < _list13.size; ++_i14)
        {
          com.skplanet.querycache.thrift.TColumnDesc _elem15;
          _elem15 = new com.skplanet.querycache.thrift.TColumnDesc();
          _elem15.read(iprot);
