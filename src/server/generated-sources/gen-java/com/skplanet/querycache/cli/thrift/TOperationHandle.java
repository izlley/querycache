...
public class TOperationHandle implements org.apache.thrift.TBase<TOperationHandle, TOperationHandle._Fields>, java.io.Serializable, Cloneable, Comparable<TOperationHandle> {
  ...
  private static final org.apache.thrift.protocol.TField UPDATE_ROW_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("updateRowCount", org.apache.thrift.protocol.TType.DOUBLE, (short)4);
  ...
  public double updateRowCount; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    UPDATE_ROW_COUNT((short)4, "updateRowCount");
  ...
  private static final int __UPDATEROWCOUNT_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.UPDATE_ROW_COUNT};
  ...
  static {
    ...
    tmpMap.put(_Fields.UPDATE_ROW_COUNT, new org.apache.thrift.meta_data.FieldMetaData("updateRowCount", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public void clear() {
    ...
    setUpdateRowCountIsSet(false);
    this.updateRowCount = 0.0;
  }
  ...
  public double getUpdateRowCount() {
    return this.updateRowCount;
  }

  public TOperationHandle setUpdateRowCount(double updateRowCount) {
    this.updateRowCount = updateRowCount;
    setUpdateRowCountIsSet(true);
    return this;
  }

  public void unsetUpdateRowCount() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __UPDATEROWCOUNT_ISSET_ID);
  }

  /** Returns true if field updateRowCount is set (has been assigned a value) and false otherwise */
  public boolean isSetUpdateRowCount() {
    return EncodingUtils.testBit(__isset_bitfield, __UPDATEROWCOUNT_ISSET_ID);
  }

  public void setUpdateRowCountIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __UPDATEROWCOUNT_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case UPDATE_ROW_COUNT:
      if (value == null) {
        ...
        setUpdateRowCount((Double)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case UPDATE_ROW_COUNT:
      return Double.valueOf(getUpdateRowCount());
  ...
  public boolean equals(TOperationHandle that) {
    ...
    boolean this_present_updateRowCount = true && this.isSetUpdateRowCount();
    boolean that_present_updateRowCount = true && that.isSetUpdateRowCount();
    if (this_present_updateRowCount || that_present_updateRowCount) {
      if (!(this_present_updateRowCount && that_present_updateRowCount))
        return false;
      if (this.updateRowCount != that.updateRowCount)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_updateRowCount = true && (isSetUpdateRowCount());
    builder.append(present_updateRowCount);
    if (present_updateRowCount)
      builder.append(updateRowCount);
  ...
  public int compareTo(TOperationHandle other) {
    ...
    lastComparison = Boolean.valueOf(isSetUpdateRowCount()).compareTo(other.isSetUpdateRowCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUpdateRowCount()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.updateRowCount, other.updateRowCount);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetUpdateRowCount()) {
      if (!first) sb.append(", ");
      sb.append("updateRowCount:");
      sb.append(this.updateRowCount);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TOperationHandleStandardScheme extends StandardScheme<TOperationHandle> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // UPDATE_ROW_COUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.updateRowCount = iprot.readDouble();
              struct.setUpdateRowCountIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOperationHandle struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.isSetUpdateRowCount()) {
        oprot.writeFieldBegin(UPDATE_ROW_COUNT_FIELD_DESC);
        oprot.writeDouble(struct.updateRowCount);
        oprot.writeFieldEnd();
      }
