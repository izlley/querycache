...
public class TFetchResultsResp implements org.apache.thrift.TBase<TFetchResultsResp, TFetchResultsResp._Fields>, java.io.Serializable, Cloneable, Comparable<TFetchResultsResp> {
  ...
  private static final org.apache.thrift.protocol.TField NUMOFROWS_FIELD_DESC = new org.apache.thrift.protocol.TField("numofrows", org.apache.thrift.protocol.TType.I64, (short)4);
  ...
  public boolean hasMoreRows; // required
  public com.skplanet.querycache.thrift.TRowSet results; // optional
  public long numofrows; // optional
  ...
  private static final int __NUMOFROWS_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private _Fields optionals[] = {_Fields.RESULTS,_Fields.NUMOFROWS};
  ...
  static {
    ...
    tmpMap.put(_Fields.HAS_MORE_ROWS, new org.apache.thrift.meta_data.FieldMetaData("hasMoreRows", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    tmpMap.put(_Fields.RESULTS, new org.apache.thrift.meta_data.FieldMetaData("results", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.skplanet.querycache.thrift.TRowSet.class)));
    tmpMap.put(_Fields.NUMOFROWS, new org.apache.thrift.meta_data.FieldMetaData("numofrows", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TFetchResultsResp(TFetchResultsResp other) {
    ...
    if (other.isSetResults()) {
      this.results = new com.skplanet.querycache.thrift.TRowSet(other.results);
    }
  ...
  public com.skplanet.querycache.thrift.TRowSet getResults() {
    return this.results;
  }

  public TFetchResultsResp setResults(com.skplanet.querycache.thrift.TRowSet results) {
  ...
  public TFetchResultsResp setNumofrows(long numofrows) {
    this.numofrows = numofrows;
    setNumofrowsIsSet(true);
    return this;
  }

  public void unsetNumofrows() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUMOFROWS_ISSET_ID);
  }

  /** Returns true if field numofrows is set (has been assigned a value) and false otherwise */
  public boolean isSetNumofrows() {
    return EncodingUtils.testBit(__isset_bitfield, __NUMOFROWS_ISSET_ID);
  }

  public void setNumofrowsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUMOFROWS_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RESULTS:
      if (value == null) {
        ...
        setResults((com.skplanet.querycache.thrift.TRowSet)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case NUMOFROWS:
      return Long.valueOf(getNumofrows());
  ...
  public boolean equals(TFetchResultsResp that) {
    ...
    boolean this_present_hasMoreRows = true;
    boolean that_present_hasMoreRows = true;
    ...
    boolean this_present_numofrows = true && this.isSetNumofrows();
    boolean that_present_numofrows = true && that.isSetNumofrows();
    if (this_present_numofrows || that_present_numofrows) {
      if (!(this_present_numofrows && that_present_numofrows))
        return false;
      if (this.numofrows != that.numofrows)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_hasMoreRows = true;
    ...
    boolean present_numofrows = true && (isSetNumofrows());
    builder.append(present_numofrows);
    if (present_numofrows)
  ...
  public int compareTo(TFetchResultsResp other) {
    ...
    lastComparison = Boolean.valueOf(isSetNumofrows()).compareTo(other.isSetNumofrows());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumofrows()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numofrows, other.numofrows);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'hasMoreRows' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TFetchResultsRespStandardScheme extends StandardScheme<TFetchResultsResp> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TFetchResultsResp struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // RESULTS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.results = new com.skplanet.querycache.thrift.TRowSet();
          ...
          case 4: // NUMOFROWS
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.numofrows = iprot.readI64();
              struct.setNumofrowsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
      ...
      if (!struct.isSetHasMoreRows()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'hasMoreRows' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFetchResultsResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetNumofrows()) {
        oprot.writeFieldBegin(NUMOFROWS_FIELD_DESC);
        oprot.writeI64(struct.numofrows);
        oprot.writeFieldEnd();
      }
